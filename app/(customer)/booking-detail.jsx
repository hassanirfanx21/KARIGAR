      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.agentCard}>
          <View style={styles.agentHeader}>
            <View style={styles.kMark}><Text style={{ color: Colors.charcoalDeep, fontWeight: '900', fontSize: 14 }}>K</Text></View>
...
const styles = StyleSheet.create({
  ...
  backArrow: { fontSize: 20, color: Colors.charcoalDeep },
  headerTitle: { flex: 1, textAlign: 'center', fontSize: 17, fontWeight: '700', color: Colors.charcoalDeep },
  ...
  heroRating: { color: Colors.goldLight, fontSize: 14, fontWeight: '600' },
  statusLarge: { paddingHorizontal: 16, paddingVertical: 6, borderRadius: Radius.full },
  statusLargeText: { fontSize: 13, fontWeight: '700' },
  heroAccent: { width: 60, height: 3, backgroundColor: `${Colors.goldPrimary}60`, borderRadius: 2, marginTop: 16 },
  sectionLabel: { color: Colors.goldPrimary, fontSize: 11, fontWeight: '800', letterSpacing: 1.5, marginBottom: 10, marginTop: 4, paddingHorizontal: 4 },
  ...
  detailIcon: { fontSize: 17, width: 26 },
  detailLabel: { color: Colors.textMuted, fontSize: 13, width: 90 },
  detailValue: { color: Colors.charcoalDeep, fontSize: 13, fontWeight: '600', textAlign: 'right', flex: 1 },
  ...
  agentTitle: { flex: 1, color: Colors.charcoalLight, fontSize: 11, fontWeight: '700', letterSpacing: 0.8 },
  toggleBtn: { color: Colors.goldPrimary, fontSize: 11, fontWeight: '700' },
  ...
  agentStepLabel: { color: Colors.charcoalLight, fontSize: 11, fontWeight: '600' },
  agentStepDone: { color: Colors.charcoalDeep, fontSize: 12, fontWeight: '700', marginTop: 1 },
  ...
  mapPin: { position: 'absolute', top: '30%', left: '43%' },
  mapLabel: { position: 'absolute', bottom: 12, left: 12, backgroundColor: Colors.charcoalDeep, paddingHorizontal: 12, paddingVertical: 6, borderRadius: Radius.full },
  ...
  contactBtn: { flex: 2, paddingVertical: 14, borderRadius: 14, backgroundColor: Colors.goldPrimary, alignItems: 'center', ...Shadows.goldFloat },
  contactBtnText: { color: Colors.charcoalDeep, fontSize: 14, fontWeight: '800' },
});
