...
const styles = StyleSheet.create({
  ...
  currentLocOuter: { position: 'absolute', width: 40, height: 40, borderRadius: 20, backgroundColor: `${Colors.goldPrimary}30`, borderWidth: 2, borderColor: `${Colors.goldPrimary}60` },
  currentLocDot: { width: 14, height: 14, borderRadius: 7, backgroundColor: Colors.goldPrimary, borderWidth: 2.5, borderColor: '#fff' },
  pin: { position: 'absolute', width: 42, height: 42, borderRadius: 21, backgroundColor: Colors.brownMatte, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#fff', transform: [{ translateX: -21 }, { translateY: -21 }], ...Shadows.card },
  pinSel: { width: 50, height: 50, borderRadius: 25, backgroundColor: Colors.goldPrimary, transform: [{ translateX: -25 }, { translateY: -25 }], zIndex: 10 },
  pinLabel: { position: 'absolute', bottom: 54, left: '50%', transform: [{ translateX: -60 }], width: 120, backgroundColor: Colors.charcoalDeep, borderRadius: 10, padding: 8, alignItems: 'center' },
  pinLabelText: { color: '#fff', fontSize: 11, fontWeight: '700', textAlign: 'center' },
  pinLabelDist: { color: Colors.goldLight, fontSize: 10, marginTop: 2 },
  areaLabel: { position: 'absolute', bottom: '40%', left: 16, backgroundColor: Colors.charcoalDeep, paddingHorizontal: 12, paddingVertical: 6, borderRadius: Radius.full },
  ...
  sheetTitle: { color: Colors.charcoalDeep, fontSize: 17, fontWeight: '800', flex: 1 },
  countBadge: { backgroundColor: Colors.charcoalDeep, paddingHorizontal: 10, paddingVertical: 4, borderRadius: Radius.full },
  ...
  filterChipText: { color: Colors.charcoalLight, fontSize: 12, fontWeight: '600' },
  ...
  workerAvatar: { width: 46, height: 46, borderRadius: 23, backgroundColor: Colors.brownMatte, alignItems: 'center', justifyContent: 'center' },
  workerName: { color: Colors.charcoalDeep, fontSize: 14, fontWeight: '700', marginBottom: 4 },
  workerMeta: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  catTag: { backgroundColor: `${Colors.goldPrimary}18`, paddingHorizontal: 8, paddingVertical: 2, borderRadius: Radius.full },
  catTagText: { color: Colors.brownMatte, fontSize: 10, fontWeight: '700' },
  workerDist: { color: Colors.goldPrimary, fontSize: 11, fontWeight: '600' },
  workerRating: { color: Colors.charcoalLight, fontSize: 12, fontWeight: '600' },
  bookBtn: { backgroundColor: Colors.goldPrimary, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 10 },
  bookBtnText: { color: Colors.charcoalDeep, fontSize: 12, fontWeight: '800' },
});
