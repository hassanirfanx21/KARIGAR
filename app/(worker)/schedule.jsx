        ...
        {SCHEDULE.map((job, i) => {
          ...
          return (
            <View key={job.id} style={styles.jobCard}>
              <View style={[styles.jobAccent, { backgroundColor: Colors.goldPrimary }]} />
...
const styles = StyleSheet.create({
  ...
  dayItemActive: { backgroundColor: Colors.goldPrimary, borderRadius: Radius.md },
  dayLabel: { color: Colors.textMuted, fontSize: 11, fontWeight: '600', marginBottom: 4 },
  dayLabelActive: { color: Colors.charcoalDeep },
  dayDate: { color: Colors.charcoalDeep, fontSize: 16, fontWeight: '800' },
  dayDateActive: { color: Colors.charcoalDeep },
  listContent: { padding: 16, paddingBottom: 40 },
  sectionLabel: { color: Colors.goldPrimary, fontSize: 10, fontWeight: '800', letterSpacing: 1.5, marginBottom: 12 },
  ...
  jobTime: { fontSize: 14, fontWeight: '700', color: Colors.charcoalDeep },
  badge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: Radius.full },
  badgeText: { fontSize: 10, fontWeight: '700' },
  jobService: { fontSize: 16, fontWeight: '600', color: Colors.charcoalDeep, marginBottom: 6 },
  jobCustomer: { fontSize: 13, color: Colors.charcoalLight, marginBottom: 2 },
  ...
  viewBtn: { backgroundColor: Colors.goldPrimary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
  viewBtnText: { color: Colors.charcoalDeep, fontSize: 12, fontWeight: '800' },
  summaryCard: { backgroundColor: Colors.brownMatte, borderRadius: Radius.xl, padding: 20, marginTop: 8, ...Shadows.cardHeavy },
  summaryTitle: { color: Colors.textOnDark, fontSize: 16, fontWeight: '700', marginBottom: 16 },
  summaryRow: { flexDirection: 'row' },
  summaryItem: { flex: 1, alignItems: 'center' },
  summaryVal: { color: Colors.goldPrimary, fontSize: 20, fontWeight: '800' },
